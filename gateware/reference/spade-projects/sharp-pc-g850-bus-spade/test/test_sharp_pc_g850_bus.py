...
async def uart_map_command_reports_saleae_pin_meanings(dut):
    ...
    assert map_lines == [
        ...
        "s: d0=wr_rawn d1=rd_rawn d2=mreq_fall d3=m1_sync d4=wr_sync d5=rd_sync d6=iorq_sync d7=mreq_sync\r\n",
        "e: d0=wr_rawn d1=rd_rawn d2=iorq_fall d3=mreq_fall d4=wr_sync d5=rd_sync d6=iorq_sync d7=mreq_sync\r\n",
