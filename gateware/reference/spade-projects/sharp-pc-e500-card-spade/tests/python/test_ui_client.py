...
from pce500_host.ui_client import ui_state_fresh_enough
...
def test_ui_state_fresh_enough_accepts_word_advance():
    current = {"status": "ok", "total_words": 12, "lcd_writes": 4}
...
def test_ui_state_fresh_enough_rejects_stale_state():
    current = {"status": "ok", "total_words": 10, "lcd_writes": 4}
    baseline = {"status": "ok", "total_words": 10, "lcd_writes": 4}
