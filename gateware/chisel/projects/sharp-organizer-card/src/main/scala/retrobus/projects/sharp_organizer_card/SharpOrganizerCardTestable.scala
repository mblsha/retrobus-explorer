...
/**
 * Sharp Organizer Card bus monitor - Testable version
 * Same functionality as SharpOrganizerCard but without explicit clock inputs
 * for compatibility with ChiselTest
 */
class SharpOrganizerCardTestable extends Module {
