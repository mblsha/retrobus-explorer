...
async def _init_test(dut, stop_bits: int, parity: int):
    ...
    # The production RX synchronizer is intentionally not reset. Keep reset
    # asserted long enough to fill all three stages with the idle-high level;
    # otherwise the first test in a fresh simulator can observe a false start.
