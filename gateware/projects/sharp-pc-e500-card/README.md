...
`gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py` auto-selects by
default.

For long-lived experiment sessions on the shared USB-UART, use:

```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-experiment-session.py
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py probe
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py timing 5
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py control-timing 10
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py ft-status
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py ft-on
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py ft-off
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py read 0x10000
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py write 0x10000 0x5A
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py \
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-card-asm.py \
  ./gateware/projects/sharp-pc-e500-card/asm/card_rom_smoke_sentinel.asm \
  --program
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/au1_usb_uart_probe.py read 0x107F1
```

## Glasgow UART

The Glasgow wrappers in `gateware/projects/sharp-pc-e500-card/scripts/` call the local
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-get.py
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-send.py path/to/program.bas
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-expd.py \
  --arm-safe-on-start \
  --monitor-uart
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-expctl.py \
  wait-ready --timeout 30

uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-expctl.py \
  --pretty \
  run ./gateware/projects/sharp-pc-e500-card/experiments/return_immediately.py

uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-expctl.py \
  --pretty \
  run ./gateware/projects/sharp-pc-e500-card/experiments/wait_probe.py -- 0x0400

uv run ./gateware/projects/sharp-pc-e500-card/experiments/catalog_experiment.py \
  list
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-iocs.py clear

uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-iocs.py \
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-iocs.py \
  spec ./gateware/projects/sharp-pc-e500-card/experiments/specs/iocs_hello_top_left.json
```
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-expfit.py \
  --pretty \
  --counts 64,128,192,224,255,256 \
  ./gateware/projects/sharp-pc-e500-card/experiments/catalog_experiment.py \
...
```sh
uv run ./gateware/projects/sharp-pc-e500-card/scripts/pc-e500-ftdecode.py \
  path/to/result.json \
  --compact
```
