...
FT_WritePipeEx.__doc__ = """FT_STATUS FT_WritePipeEx(FT_HANDLE ftHandle, UCHAR ucFifoID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, DWORD dwTimeoutInMs)"""
...
FT_ReadPipeEx.__doc__ = """FT_STATUS FT_ReadPipeEx(FT_HANDLE ftHandle, UCHAR ucFifoID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, DWORD dwTimeoutInMs)"""
