...
FT_WritePipeEx.__doc__ = \
    """FT_STATUS FT_WritePipeEx(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""
...
FT_ReadPipeEx.__doc__ = \
    """FT_STATUS FT_ReadPipeEx(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""
