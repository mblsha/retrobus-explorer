...
_libname = "./ftd3xx.dll"
_libraries = {}
_libraries[_libname] = c.cdll.LoadLibrary(_libname)  # WinDLL(_libname)
...
FT_FlushPipe.__doc__ = """FT_STATUS FT_FlushPipe(FT_HANDLE ftHandle, UCHAR ucPipeID)"""
...
FT_GetDeviceDescriptor.__doc__ = """FT_STATUS FT_GetDeviceDescriptor(FT_HANDLE ftHandle, PFT_DEVICE_DESCRIPTOR ptDescriptor)"""
...
FT_GetConfigurationDescriptor.__doc__ = """FT_STATUS FT_GetConfigurationDescriptor(FT_HANDLE ftHandle, PFT_CONFIGURATION_DESCRIPTOR ptDescriptor)"""
...
FT_GetInterfaceDescriptor.__doc__ = """FT_STATUS FT_GetInterfaceDescriptor(FT_HANDLE ftHandle, UCHAR ucInterfaceIndex, PFT_INTERFACE_DESCRIPTOR ptDescriptor)"""
...
FT_GetDescriptor.__doc__ = """FT_STATUS FT_GetDescriptor(FT_HANDLE ftHandle, UCHAR ucDescriptorType, UCHAR ucIndex, PFT_STRING_DESCRIPTOR pucBuffer, ULONG ulBufferLength, PULONG pulLengthTransferred)"""
...
FT_GetPipeInformation.__doc__ = """FT_STATUS FT_GetPipeInformation(FT_HANDLE ftHandle, UCHAR ucInterfaceIndex, UCHAR ucPipeIndex, PFT_PIPE_INFORMATION ptPipeInformation)"""
...
FT_ControlTransfer.__doc__ = """FT_STATUS FT_ControlTransfer(FT_HANDLE ftHandle, FT_SETUP_PACKET tSetupPacket, PUCHAR pucBuffer, ULONG ulBufferLength, PULONG pulLengthTransferred)"""
...
FT_ResetDevicePort.__doc__ = """FT_STATUS FT_ResetDevicePort(FT_HANDLE ftHandle)"""
...
FT_ReadGPIO.__doc__ = """FT_STATUS FT_ReadGPIO(FT_HANDLE ftHandle, PULONG pu32Data)"""
...
FT_WritePipe.__doc__ = """FT_STATUS FT_WritePipe(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""

FT_WritePipeEx = _libraries[_libname].FT_WritePipeEx
FT_WritePipeEx.restype = FT_STATUS
# FT_WritePipeEx(ftHandle, ucPipeID, pucBuffer, ulBufferLength, pulBytesTransferred, pOverlapped)
FT_WritePipeEx.argtypes = [FT_HANDLE, UCHAR, LPVOID, ULONG, PULONG, LPOVERLAPPED]
FT_WritePipeEx.__doc__ = """FT_STATUS FT_WritePipeEx(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""
...
FT_ReadPipe.__doc__ = """FT_STATUS FT_ReadPipe(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""

FT_ReadPipeEx = _libraries[_libname].FT_ReadPipeEx
FT_ReadPipeEx.restype = FT_STATUS
# FT_ReadPipe(ftHandle, ucPipeID, pucBuffer, ulBufferLength, pulBytesTransferred, pOverlapped)
FT_ReadPipeEx.argtypes = [FT_HANDLE, UCHAR, LPVOID, ULONG, PULONG, LPOVERLAPPED]
FT_ReadPipeEx.__doc__ = """FT_STATUS FT_ReadPipeEx(FT_HANDLE ftHandle, UCHAR ucPipeID, LPVOID pucBuffer, ULONG ulBufferLength, PULONG pulBytesTransferred, LPOVERLAPPED pOverlapped)"""
...
FT_GetOverlappedResult.__doc__ = """FT_STATUS FT_GetOverlappedResult(FT_HANDLE ftHandle, LPOVERLAPPED pOverlapped, PULONG pulBytesTransferred, BOOL bWait)"""
...
FT_InitializeOverlapped.__doc__ = """FT_STATUS FT_InitializeOverlapped(FT_HANDLE ftHandle, LPOVERLAPPED pOverlapped)"""
...
FT_AbortPipe.__doc__ = """FT_STATUS FT_AbortPipe(FT_HANDLE ftHandle, UCHAR ucPipeID)"""
...
FT_SetPipeTimeout.__doc__ = """FT_STATUS FT_SetPipeTimeout(FT_HANDLE ftHandle, UCHAR ucPipeID, ULONG TimeoutInMs)"""
...
FT_GetPipeTimeout.__doc__ = """FT_STATUS FT_GetPipeTimeout(FT_HANDLE ftHandle, UCHAR ucPipeID, PULONG pTimeoutInMs)"""
...
FT_SetStreamPipe.__doc__ = """FT_STATUS FT_SetStreamPipe(FT_HANDLE ftHandle, BOOLEAN bAllWritePipes, BOOLEAN bAllReadPipes, UCHAR ucPipeID, ULONG ulStreamSize)"""
...
FT_ClearStreamPipe.__doc__ = """FT_STATUS FT_ClearStreamPipe(FT_HANDLE ftHandle, BOOLEAN bAllWritePipes, BOOLEAN bAllReadPipes, UCHAR ucPipeID)"""
...
FT_SetNotificationCallback.__doc__ = """FT_STATUS FT_SetNotificationCallback(FT_HANDLE ftHandle, FT_NOTIFICATION_CALLBACK pCallback, PVOID pvCallbackContext)"""
...
FT_CycleDevicePort.__doc__ = """FT_STATUS FT_CycleDevicePort(FT_HANDLE ftHandle)"""
